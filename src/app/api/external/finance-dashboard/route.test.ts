  ...
  beforeEach(() => {
    ...
    prismaMock.imladrisCanonicalMetricValue.findMany.mockResolvedValue([
      ...
      canonicalMetric({
        ...
        department: "customer_success",
        unit: "count",
        value: { count: 43, activeAccounts: 31 },
      }),
      canonicalMetric({
        ...
        department: "customer_success",
        unit: "percent",
        value: { rate: 5, churnedCustomers: 1, retainedCustomers: 19, customerBase: 20 },
      }),
      canonicalMetric({
        ...
        department: "customer_success",
        unit: "percent",
        value: { rate: 95, retainedCustomers: 19, churnedCustomers: 1, customerBase: 20 },
      }),
      canonicalMetric({
        ...
        department: "customer_success",
        unit: "count",
        value: { count: 1, escalations: 2, accountsWithBillingRisk: 1, lowUsageAccounts: 3 },
      }),
    ]);
