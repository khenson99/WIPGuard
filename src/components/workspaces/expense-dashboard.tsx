      ...
      <div className="expense-grid expense-g4">
        <div className="expense-card">
          ...
          <div className="expense-card-sub">
            {primaryCategory ? `${fmt(data.categoryTotals[primaryCategory])} · ${pct(data.categoryTotals[primaryCategory], total)}` : "No category spend"}
          </div>
        </div>
        <div className="expense-card">
        ...
        <div className="expense-card">
          ...
          <div className="expense-card-value expense-green">
