...
const COMPANY: CompanyTrackerDashboardData = {
  ...
  summary: {
    ...
    expenses: null,
    grossMargin: null,
    grossMarginRevenue: null,
    costOfGoodsSold: null,
    stripeProcessingFees: null,
    qualifiedPipeline: 1_000_000,
    qualifiedPipelineCount: null,
    collaborationTouchCount: null,
    collaborationCoverage: null,
    demos: null,
    scheduledDemos: null,
    requestedDemos: null,
    hubspotDemoDeals: null,
    hubspotDemoMeetings: null,
    calendarDemoEvents: null,
    webflowDemoRequests: null,
    activeSubscriptions: 42,
    stripeSubscriptions: null,
    hubspotOnlySubscriptions: null,
    customers: null,
    stripeCustomers: null,
    hubspotOnlyCustomers: null,
    websiteTraffic: null,
    websiteSessions: null,
    posthogPageviews: null,
    organicTraffic: null,
    searchClicks: null,
    searchImpressions: null,
    conversionRate: null,
    conversions: null,
    webflowFormSubmissions: null,
    hubspotLeadConversions: null,
    posthogConversions: null,
    identifiedVisitors: null,
    pipelineEfficiency: null,
    ...
    customerHealth: null,
    atRiskAccounts: null,
    openSupportIssues: null,
    customerActivity: null,
    supportInteractions: null,
    productUsageRecords: null,
    collaborationSignals: null,
    customerActivityActiveAccounts: null,
    churnRate: null,
    retentionRate: null,
    churnedCustomers: null,
    retainedCustomers: null,
    retentionCustomerBase: null,
    retentionRiskScore: null,
    retentionRiskAccounts: null,
    retentionRiskEscalations: null,
    retentionRiskBillingRiskAccounts: null,
    retentionRiskLowUsageAccounts: null,
    currency: "USD",
  },
  northStar: {
    ...
    currentMrr: 32_000,
    netNewArr: null,
    formula: "Net new ARR vs. burn",
    sourceMetricKeys: ["revenue.mrr", "finance.net_burn"],
    drivers: [],
  },
  benchmarkContext: {
    items: [],
