...
const MERCURY_TRANSACTION_OBJECT_TYPES = imladrisObjectTypeQueryVariants("transaction", "bank_transaction");

const MERCURY_BALANCE_OBJECT_TYPES = imladrisObjectTypeQueryVariants("account_balance", "balance");
