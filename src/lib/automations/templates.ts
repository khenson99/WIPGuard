        ...
        },
        {
          ...
          config: {
            ...
            instructionsTemplate: [
              ...
              "3. Recommendations for HubSpot updates, follow-up task creation, Gmail draft creation, and calendar invite drafting when a next meeting was agreed.",
              "Use action types create_task, update_hubspot, create_gmail_draft, and create_calendar_draft.",
        ...
        },
        {
          ...
          config: {
            ...
            instructionsTemplate: [
              ...
              "Recommendations should cover create_task, update_hubspot, create_gmail_draft, create_calendar_draft, and post_slack_digest when internal visibility is required.",
              "Use create_task for follow-up reminders over the coming days and weeks.",
        ...
        },
        {
          ...
          config: {
            ...
            instructionsTemplate: [
              ...
              "Use create_task for internal intervention work, update_hubspot for CRM notes, and create_gmail_draft only when customer outreach is warranted.",
