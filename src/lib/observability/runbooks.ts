  ...
  steps: [
    {
      ...
      command: "GET /api/events -> metrics.counts, metrics.lag",
    ...
    },
    {
      ...
      command: "GET /api/events -> metrics.recentDeadLetters",
    ...
    },
    {
      ...
      command: "POST /api/events/dead-letter { \"eventIds\": [\"...\"], \"reason\": \"manual queue unblock\" }",
...
export const RUNBOOK_WEBSOCKET_DEGRADATION: Runbook = {
  ...
  steps: [
    ...
    },
    {
      ...
      command: "GET /api/events -> metrics.lag",
